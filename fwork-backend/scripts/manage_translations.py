...
#
# This python file contains utility scripts to manage tina translations.
# It has to be run inside the tina-back git root directory.
#
# The following commands are available:
#
# * update_catalogs: check for new strings in tina-back catalogs, and
...
#
#  $ python scripts/manage_translations.py lang_stats --language=es --resources=tina
...
def update_catalogs(resources=None, languages=None):
    ...
    os.chdir(os.getcwd())
    print("Updating en catalogs for all tina-back resourcess...")
    cmd.handle(**opts)
...
def lang_stats(resources=None, languages=None):
    ...
    limit the output (e.g. ['main', 'tina']).
    """
...
You need transifex-client, install it.
 ...
 2. Create ~/.transifexrc file:
    ...
    parser = ArgumentParser(description="manage translations in tina-back between the repo and transifex.",
