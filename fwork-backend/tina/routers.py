...
# Locales
from tina.locale.api import LocalesViewSet

router.register(r"locales", LocalesViewSet, base_name="locales")


# Users & Roles
from tina.auth.api import AuthViewSet
from tina.users.api import UsersViewSet
from tina.users.api import RolesViewSet
...
# User Storage
from tina.userstorage.api import StorageEntriesViewSet

router.register(r"user-storage", StorageEntriesViewSet, base_name="user-storage")


# Notifications & Notify policies
from tina.projects.notifications.api import NotifyPolicyViewSet
from tina.projects.notifications.api import WebNotificationsViewSet
...
# Project settings
from tina.projects.settings.api import UserProjectSettingsViewSet, SectionsViewSet
...
# Projects & Selectors
from tina.projects.api import ProjectViewSet
from tina.projects.api import ProjectFansViewSet
from tina.projects.api import ProjectWatchersViewSet
from tina.projects.api import MembershipViewSet
from tina.projects.api import InvitationViewSet
from tina.projects.api import EpicStatusViewSet
from tina.projects.api import UserStoryStatusViewSet
from tina.projects.api import PointsViewSet
from tina.projects.api import UserStoryDueDateViewSet
from tina.projects.api import TaskStatusViewSet
from tina.projects.api import TaskDueDateViewSet
from tina.projects.api import IssueStatusViewSet
from tina.projects.api import IssueTypeViewSet
from tina.projects.api import IssueDueDateViewSet
from tina.projects.api import PriorityViewSet
from tina.projects.api import SeverityViewSet
from tina.projects.api import ProjectTemplateViewSet
...
# Custom Attributes
from tina.projects.custom_attributes.api import EpicCustomAttributeViewSet
from tina.projects.custom_attributes.api import UserStoryCustomAttributeViewSet
from tina.projects.custom_attributes.api import TaskCustomAttributeViewSet
from tina.projects.custom_attributes.api import IssueCustomAttributeViewSet

from tina.projects.custom_attributes.api import EpicCustomAttributesValuesViewSet
from tina.projects.custom_attributes.api import UserStoryCustomAttributesValuesViewSet
from tina.projects.custom_attributes.api import TaskCustomAttributesValuesViewSet
from tina.projects.custom_attributes.api import IssueCustomAttributesValuesViewSet
...
# Search
from tina.searches.api import SearchViewSet

router.register(r"search", SearchViewSet, base_name="search")


# Resolver
from tina.projects.references.api import ResolverViewSet

router.register(r"resolver", ResolverViewSet, base_name="resolver")


# Attachments
from tina.projects.attachments.api import EpicAttachmentViewSet
from tina.projects.attachments.api import UserStoryAttachmentViewSet
from tina.projects.attachments.api import IssueAttachmentViewSet
from tina.projects.attachments.api import TaskAttachmentViewSet
from tina.projects.attachments.api import WikiAttachmentViewSet
...
# Project components
from tina.projects.milestones.api import MilestoneViewSet
from tina.projects.milestones.api import MilestoneWatchersViewSet

from tina.projects.epics.api import EpicViewSet
from tina.projects.epics.api import EpicRelatedUserStoryViewSet
from tina.projects.epics.api import EpicVotersViewSet
from tina.projects.epics.api import EpicWatchersViewSet

from tina.projects.userstories.api import UserStoryViewSet
from tina.projects.userstories.api import UserStoryVotersViewSet
from tina.projects.userstories.api import UserStoryWatchersViewSet

from tina.projects.tasks.api import TaskViewSet
from tina.projects.tasks.api import TaskVotersViewSet
from tina.projects.tasks.api import TaskWatchersViewSet

from tina.projects.issues.api import IssueViewSet
from tina.projects.issues.api import IssueVotersViewSet
from tina.projects.issues.api import IssueWatchersViewSet

from tina.projects.wiki.api import WikiViewSet
from tina.projects.wiki.api import WikiLinkViewSet
from tina.projects.wiki.api import WikiWatchersViewSet
...
from tina.projects.api import DeleteOwnProjectsViewSet
...
# History & Components
from tina.projects.history.api import EpicHistory
from tina.projects.history.api import UserStoryHistory
from tina.projects.history.api import TaskHistory
from tina.projects.history.api import IssueHistory
from tina.projects.history.api import WikiHistory
...
# Contact
from tina.projects.contact.api import ContactViewSet
router.register(r"contact", ContactViewSet, base_name="contact")


# Timelines
from tina.timeline.api import ProfileTimeline
from tina.timeline.api import UserTimeline
from tina.timeline.api import ProjectTimeline
...
# Webhooks
from tina.webhooks.api import WebhookViewSet
from tina.webhooks.api import WebhookLogViewSet
...
# GitHub webhooks
from tina.hooks.github.api import GitHubViewSet

router.register(r"github-hook", GitHubViewSet, base_name="github-hook")


# Gitlab webhooks
from tina.hooks.gitlab.api import GitLabViewSet

router.register(r"gitlab-hook", GitLabViewSet, base_name="gitlab-hook")


# Bitbucket webhooks
from tina.hooks.bitbucket.api import BitBucketViewSet

router.register(r"bitbucket-hook", BitBucketViewSet, base_name="bitbucket-hook")


# Gogs webhooks
from tina.hooks.gogs.api import GogsViewSet

router.register(r"gogs-hook", GogsViewSet, base_name="gogs-hook")


# Importer
from tina.export_import.api import ProjectImporterViewSet, ProjectExporterViewSet
...
# External apps
from tina.external_apps.api import Application, ApplicationToken
...
if settings.IMPORTERS.get('trello', {}).get('active', False):
    from tina.importers.trello.api import TrelloImporterViewSet
...
if settings.IMPORTERS.get('jira', {}).get('active', False):
    from tina.importers.jira.api import JiraImporterViewSet
...
if settings.IMPORTERS.get('github', {}).get('active', False):
    from tina.importers.github.api import GithubImporterViewSet
...
if settings.IMPORTERS.get('asana', {}).get('active', False):
    from tina.importers.asana.api import AsanaImporterViewSet
    router.register(r"importers/asana", AsanaImporterViewSet, base_name="importers-asana")


# Stats
#   - see tina.stats.routers and tina.stats.apps


# Feedback
#   - see tina.feedback.routers and tina.feedback.apps
