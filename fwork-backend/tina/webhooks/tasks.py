...
from tina.base.api.renderers import UnicodeJSONRenderer
from tina.base.utils import json, urls
...
def _send_request(webhook_id, url, key, data):
    ...
    headers = {
        "X-Tina-WEBHOOK-SIGNATURE": signature,        # For backward compatibility
