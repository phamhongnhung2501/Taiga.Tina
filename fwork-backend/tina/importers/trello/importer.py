...
from tina.projects.services import projects as projects_service
...
from tina.base import exceptions
...
class TrelloImporter:
    ...
    def list_users(self, project_id):
        ...
        for member in self._client.get("/board/{}/members/all".format(project_id), {"fields": "id"}):
            ...
            try:
                ...
                #
                # File "/home/tina/tina-back/tina/importers/trello/importer.py" in list_users
    ...
    def _transform_action_data(self, us, action, statuses, options):
        ...
        Tina_user = users_bindings.get(action.get('memberCreator', {}).get('id', None), None)
        if Tina_user:
