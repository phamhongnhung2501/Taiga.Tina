...
from tina.permissions import permissions
from tina.projects.notifications.admin import NotifyPolicyInline
from tina.projects.likes.admin import LikeInline
from tina.users.admin import RoleInline
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    def delete_selected(self, request, queryset):
        # NOTE: This must be equal to tina.projects.models.Project.delete_related_content
