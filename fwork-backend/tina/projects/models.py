...
from tina.projects.custom_attributes.models import EpicCustomAttribute
from tina.projects.custom_attributes.models import UserStoryCustomAttribute
from tina.projects.custom_attributes.models import TaskCustomAttribute
from tina.projects.custom_attributes.models import IssueCustomAttribute
from tina.projects.tagging.models import TaggedMixin
from tina.projects.tagging.models import TagsColorsMixin
from tina.base.utils.files import get_file_path
from tina.base.utils.slug import slugify_uniquely
from tina.base.utils.slug import slugify_uniquely_for_queryset

from tina.permissions.choices import ANON_PERMISSIONS, MEMBERS_PERMISSIONS

from tina.projects.notifications.choices import NotifyLevel
from tina.projects.notifications.services import (
    set_notify_policy_level,
    set_notify_policy_level_to_ignore,
    create_notify_policy_if_not_exists)

from tina.timeline.service import build_project_namespace
...
class Project(ProjectDefaults, TaggedMixin, TagsColorsMixin, models.Model):
    ...
    def delete_related_content(self):
        # NOTE: Remember to update code in tina.projects.admin.ProjectAdmin.delete_selected
        from tina.events.apps import (connect_events_signals,
                                      disconnect_events_signals)
        from tina.projects.epics.apps import (connect_all_epics_signals,
                                              disconnect_all_epics_signals)
        from tina.projects.tasks.apps import (connect_all_tasks_signals,
                                              disconnect_all_tasks_signals)
        from tina.projects.userstories.apps import (connect_all_userstories_signals,
                                                    disconnect_all_userstories_signals)
        from tina.projects.issues.apps import (connect_all_issues_signals,
                                               disconnect_all_issues_signals)
        from tina.projects.apps import (connect_memberships_signals,
