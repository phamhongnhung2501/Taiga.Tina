...
from tina.base.utils.db import get_object_or_none
...
from tina.projects.tasks.validators import UpdateMilestoneBulkValidator as \
    TasksUpdateMilestoneValidator
from tina.projects.issues.validators import UpdateMilestoneBulkValidator as \
...
class MilestoneViewSet(HistoryResourceMixin, WatchedResourceMixin,
    ...
    def list(self, request, *args, **kwargs):
        ...
        self._add_Tina_info_headers()
        return res

    def _add_Tina_info_headers(self):
        try:
        ...
        if project:
            ...
            self.headers["Tina-Info-Total-Opened-Milestones"] = opened_milestones
            self.headers["Tina-Info-Total-Closed-Milestones"] = closed_milestones
