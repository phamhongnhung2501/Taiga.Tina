...
def attach_userstories_new_numbers(queryset, user, as_field="userstories_new_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
             ...
             FROM (
                 SELECT userstories_userstory.id
                   ...
                   WHERE userstories_userstory.project_id = {tbl}.id AND
                        userstories_userstory.status_id = 1
                  ) t
          """
...
def attach_userstories_ready_numbers(queryset, user, as_field="userstories_ready_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
                 ...
                 FROM (
                     SELECT userstories_userstory.id
                       FROM userstories_userstory
                       WHERE userstories_userstory.project_id = {tbl}.id AND
                            userstories_userstory.status_id = 2
                      ) t
              """
...
def attach_userstories_in_progress_numbers(queryset, user, as_field="userstories_in_progress_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
                 ...
                 FROM (
                     SELECT userstories_userstory.id
                       FROM userstories_userstory
                       WHERE userstories_userstory.project_id = {tbl}.id AND
                            userstories_userstory.status_id = 3
                      ) t
              """
...
def attach_userstories_ready_for_test_numbers(queryset, user, as_field="userstories_ready_for_test_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
                 ...
                 FROM (
                     SELECT userstories_userstory.id
                       FROM userstories_userstory
                       WHERE userstories_userstory.project_id = {tbl}.id AND
                            userstories_userstory.status_id = 4
                      ) t
              """
...
def attach_userstories_done_numbers(queryset, user, as_field="userstories_done_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
                 ...
                 FROM (
                     SELECT userstories_userstory.id
                       FROM userstories_userstory
                       WHERE userstories_userstory.project_id = {tbl}.id AND
                            userstories_userstory.status_id = 5
                      ) t
              """
...
def attach_userstories_archived_numbers(queryset, user, as_field="userstories_archived_attr"):
    """Attach a homepage array to each object of the queryset.
    ...
    sql = """
                 ...
                 FROM (
                     SELECT userstories_userstory.id
                       FROM userstories_userstory
                       WHERE userstories_userstory.project_id = {tbl}.id AND
                            userstories_userstory.status_id = 6
                      ) t
              """
...
def attach_basic_info(queryset, user=None):
    ...
    queryset = attach_public_projects_same_owner(queryset, user)
    queryset = attach_my_homepage(queryset, user)
    queryset = attach_userstories_new_numbers(queryset, user)
    queryset = attach_userstories_ready_numbers(queryset, user)
    queryset = attach_userstories_in_progress_numbers(queryset, user)
    queryset = attach_userstories_ready_for_test_numbers(queryset, user)
    queryset = attach_userstories_done_numbers(queryset, user)
    queryset = attach_userstories_archived_numbers(queryset, user)
