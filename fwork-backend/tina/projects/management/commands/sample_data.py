...
from tina.users.models import *
from tina.permissions.choices import ANON_PERMISSIONS
from tina.projects.choices import BLOCKED_BY_STAFF
from tina.external_apps.models import Application, ApplicationToken
from tina.projects.models import *
from tina.projects.epics.models import *
from tina.projects.milestones.models import *
from tina.projects.notifications.choices import NotifyLevel
from tina.projects.services.stats import get_stats_for_project
...
from tina.projects.wiki.models import *
from tina.projects.attachments.models import *
from tina.projects.custom_attributes.models import *
from tina.projects.custom_attributes.choices import TYPES_CHOICES, TEXT_TYPE, MULTILINE_TYPE, DATE_TYPE, URL_TYPE
from tina.projects.history.services import take_snapshot
from tina.projects.likes.services import add_like
from tina.projects.votes.services import add_vote
from tina.events.apps import disconnect_events_signals
from tina.projects.services.stats import get_stats_for_project


ATTACHMENT_SAMPLE_DATA = [
    "tina/projects/management/commands/sample_data",
    [".txt", ]
]
...
class Command(BaseCommand):
    ...
    def create_user(self, counter=None, username=None, full_name=None, email=None):
        ...
        email = email or "user{0}@Tinaio.demo".format(counter)
