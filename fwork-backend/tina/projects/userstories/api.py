...
from tina.base import filters as base_filters
from tina.base import exceptions as exc
from tina.base import response
from tina.base import status
...
from tina.projects.mixins.by_ref import ByRefMixin
from tina.projects.models import Project, UserStoryStatus
from tina.projects.notifications.mixins import AssignedUsersSignalMixin
...
from tina.projects.tagging.api import TaggedResourceMixin
from tina.projects.votes.mixins.viewsets import VotedResourceMixin
from tina.projects.votes.mixins.viewsets import VotersViewSetMixin
from tina.projects.userstories.utils import attach_extra_info
...
class UserStoryViewSet(AssignedUsersSignalMixin, OCCResourceMixin,
    ...
    def post_save(self, obj, created=False):
        if not created:
            ...
            orders_updated.update(updated)
            self.headers["Tina-Info-Order-Updated"] = json.dumps(orders_updated)
