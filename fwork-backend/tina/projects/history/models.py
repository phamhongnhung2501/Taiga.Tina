...
from tina.mdrender.service import get_diff_of_htmls

from .choices import HistoryType
from .choices import HISTORY_TYPE_CHOICES

from tina.base.utils.diff import make_diff as make_diff_from_dicts
from tina.projects.custom_attributes.choices import CHECKBOX_TYPE, NUMBER_TYPE, TEXT_TYPE
...
class HistoryEntry(models.Model):
    ...
    def attach_user_info_to_comment_versions(self):
        ...
        from tina.users.serializers import UserSerializer
