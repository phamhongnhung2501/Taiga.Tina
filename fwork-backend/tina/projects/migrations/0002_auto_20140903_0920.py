...
import tina.projects.history.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_options', tina.base.db.models.fields.JSONField(null=True, verbose_name='default options', blank=True)),
                ('us_statuses', tina.base.db.models.fields.JSONField(null=True, verbose_name='us statuses', blank=True)),
                ('points', tina.base.db.models.fields.JSONField(null=True, verbose_name='points', blank=True)),
                ('task_statuses', tina.base.db.models.fields.JSONField(null=True, verbose_name='task statuses', blank=True)),
                ('issue_statuses', tina.base.db.models.fields.JSONField(null=True, verbose_name='issue statuses', blank=True)),
                ('issue_types', tina.base.db.models.fields.JSONField(null=True, verbose_name='issue types', blank=True)),
                ('priorities', tina.base.db.models.fields.JSONField(null=True, verbose_name='priorities', blank=True)),
                ('severities', tina.base.db.models.fields.JSONField(null=True, verbose_name='severities', blank=True)),
                ('roles', tina.base.db.models.fields.JSONField(null=True, verbose_name='roles', blank=True)),
            ],
            options={
