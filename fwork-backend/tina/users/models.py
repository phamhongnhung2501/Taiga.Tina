...
from tina.base.utils.colors import generate_random_hex_color
...
from tina.projects.choices import BLOCKED_BY_OWNER_LEAVING
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def cancel(self):
        with advisory_lock("delete-user"):
            ...
            self.email = "{}@tina.io".format(self.username)
