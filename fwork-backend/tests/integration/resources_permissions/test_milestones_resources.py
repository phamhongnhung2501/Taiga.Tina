...
from tina.projects.milestones.serializers import MilestoneSerializer
from tina.projects.milestones.models import Milestone
from tina.projects.milestones.utils import attach_extra_info as attach_milestone_extra_info
