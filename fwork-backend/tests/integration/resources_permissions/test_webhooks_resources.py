...
from tina.webhooks.serializers import WebhookSerializer
from tina.webhooks.models import Webhook
...
def test_webhook_action_test(client, data):
    ...
    with mock.patch('tina.webhooks.tasks._send_request') as _send_request_mock:
